...
class TestGetCurrentSsid:
    ...
    def test_returns_ssid_from_output(self):
        with patch('wallpaper_automator.evaluator.wifi_ssid_evaluator.subprocess.check_output') as mock_check_output:
...
class TestWIFISsidEvaluator:
    ...
    def test_returns_true_when_ssid_matches(self, evaluator):
        with patch('wallpaper_automator.evaluator.wifi_ssid_evaluator.get_current_ssid') as mock_get_ssid:
